...
// Large enough to contain vert long CSS selectors
...
int main() {
  ...
  std::cout << "[INFO] Launching the HTML rule module of ShadowBlock\n"
	    << std::endl;
  ...
  while (TRUE) {
    ...
    if (FD_ISSET(master_socket, &readfds)) {
      ...
      printf("[INFO] New incoming connection\n");
      ...
      for (i = 0; i < max_clients; i++) {
        ...
        if (client_socket[i] == 0) {
          ...
          printf("[INFO] Adding to list of sockets\n");
          break;
        }
      }
    }
    ...
    for (i = 0; i < max_clients; i++) {
      ...
      if (FD_ISSET(sd, &readfds)) {
        ...
        // Echo back the message that came in
          ...
          std::cout << "[INFO] Length of msg: " << valread << "\n";
          ...
          std::cout << "[INFO] Size of domain selectors: "
		    << domain_selectors.size() 
		    << std::endl;
          std::cout << "[INFO] Size of generic selectors: "
          ...
          std::cout << "[INFO] Size of final selectors: "
